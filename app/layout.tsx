...
export const metadata: Metadata = {
  metadataBase: new URL("https://portfolio-safaryan.vercel.app/"),
  title: "Sergey Safaryan | Lead Software Engineer",
  description:
  ...
  authors: [{ name: "Sergey Safaryan" }],
  openGraph: {
    title: "Sergey Safaryan | Lead Software Engineer",
    description:
      "Lead Software Engineer specializing in GenAI systems, distributed systems, and cloud architecture.",
    url: "https://portfolio-safaryan.vercel.app/",
    siteName: "Sergey Safaryan Portfolio",
    type: "website",
  },
};
