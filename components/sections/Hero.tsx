    ...
    >
      ...
      <div data-hero-content className="relative z-10 mx-auto w-full max-w-7xl">
        ...
        <p className="mt-8 max-w-xl text-base leading-relaxed text-text-muted md:text-lg">
          {portfolio.title} — {portfolio.tagline}. Building responsive, scalable web applications with clean architecture and pixel-perfect interfaces.
Focused on performance, modern frontend development, and seamless API integration.
        </p>
